...
const getPassword = async (ormOpts: PostgresConnectionOptions): Promise<string | undefined> => {
...
export const safeCreateConnection = async (ormOpts: PostgresConnectionOptions): Promise<Connection> => {
    if (conn) {
        return conn
    }
